...
* (п1) Классы всегда в нижнем регистре через "-" или "_", классы используемые в js в camelCase.
* (п1) Теги всегда в нижнем регистре, исключение для "кастомных элементов" framework-ов.
* (п1) Селекторы/Якоря для js в camelCase.
...
* (п1) Названия всех классов должно иметь префикс
```css
...
* (п1) В модулях активно применяем согласованный [БЭМ](css).
* (п2) Файловая структура, придерживаться [примера](css)
